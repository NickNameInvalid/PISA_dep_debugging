...
//                              App<arg::Index, arg::WandData<arg::WandMode::Required>, arg::Query<arg::QueryMode::Ranked>, arg::Algorithm, arg::Scorer, arg::Thresholds, arg::Threads> & app, string term, uint64_t did)
//            {
//                termdidlist_search td_s;
//                query_res score_list = {app.lookup(std::move(term)), {did}};
//                const Query& single_query = score_list.term;
//                std::vector<uint64_t> & dids = score_list.dids;
//                std::vector<double> lookup_score = td_s(make_max_scored_cursors(index, wdata, *scorer, single_query) , index.num_docs(), dids);
